...
if __name__ == "__main__":
    ...
    stage_map = {
            2: "logs/T004-BB0_2023-09-06-14-02-46/checkpoints/trainstep_checkpoints/epoch=000002-step=000009999.ckpt",
            3: "logs/T004-BB0_2023-09-06-14-02-46/checkpoints/trainstep_checkpoints/epoch=000005-step=000019999.ckpt",
            4: "logs/T004-BB0_2023-09-06-14-02-46/checkpoints/trainstep_checkpoints/epoch=000007-step=000024999.ckpt",
            5: "logs/T004-BB0_2023-09-06-14-02-46/checkpoints/trainstep_checkpoints/epoch=000008-step=000029999.ckpt",
            6: "logs/T004-BB0_2023-09-06-14-02-46/checkpoints/trainstep_checkpoints/epoch=000011-step=000039999.ckpt",
            7: "logs/T004-BB0_2023-09-06-14-02-46/checkpoints/trainstep_checkpoints/epoch=000013-step=000044999.ckpt",
            8: "logs/T004-BB0_2023-09-06-14-02-46/checkpoints/trainstep_checkpoints/epoch=000014-step=000049999.ckpt",
            9: "logs/T004-BB0_2023-09-06-14-02-46/checkpoints/epoch=000015.ckpt",
    }
    ...
    config.model.params.ckpt_path = stage_map[stage]
    ...
    timesteps, _ = model.gen_timestep(stage)
        ...
        for i, value in enumerate(tqdm(dataloader)):
            ...
            for idx in tqdm(range(cnt)):
                ...
                for j, item in enumerate(range(len(x))):
                    ...
                    img_out.save(join(logdir, f"s{stage}_e{eta:1.1f}_{i*batch_size+j:04d}_{t:03d}output.png"))
